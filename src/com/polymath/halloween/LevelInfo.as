package com.polymath.halloween 
{
	...
	import com.polymath.halloween.abilities.AbilityInfo;
	
	public class LevelInfo extends FlxGroup 
	{
		...
		public function LevelInfo() 
		{
			...
			_header = new FlxText(0, 5, 200, "Foo").setFormat(null, 8, 0xFFFFFFFF, "center", 0xFF000000);
			
			_text = new FlxText(5, 5 + _header.height + 5, 200, "This is some text bullshit").setFormat(null, 8, 0xFFFFFFFF, "left", 0xFF000000);
		...
		public function show():void
		{
			...
			var header:String = AbilityInfo.getLevelInfoHeader();
			var body:String = AbilityInfo.getLevelInfoBody();
